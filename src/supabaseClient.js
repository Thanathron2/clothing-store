...
if (isMock) {
  ...
  const getDB = () => {
    ...
    const initialData = {
      ...
      profiles: [
        { id: 'admin-id', username: 'admin', display_name: 'AURA Store Manager', role: 'admin', phone: '0812345678', address: '123 AURA Fashion Building, Sukhumvit Rd, Bangkok 10110', avatar_url: 'https://api.dicebear.com/7.x/pixel-art/svg?seed=admin' },
        { id: 'user-id', username: 'fashionista', display_name: 'Alex Rivera', role: 'user', phone: '0898765432', address: '456 Cyber Tower, Pathum Wan, Bangkok 10330', avatar_url: 'https://api.dicebear.com/7.x/pixel-art/svg?seed=fashionista' }
      ],
      categories: [
      ...
      products: [
        {
          ...
          description: 'เสื้อยืดแขนสั้น Oversized ผลิตจากผ้า Cotton 100% เกรดพรีเมียม 260GSM นุ่มสบาย ระบายอากาศได้ดีเยี่ยม ทรงสวยอยู่ทรงตลอดวัน',
          image_url: 'https://down-th.img.susercontent.com/file/sg-11134201-7rdvs-lyg5c0ylia1u5e',
          additional_images: [],
          sizes: ['S', 'M', 'L', 'XL', 'XXL'],
        ...
        },
        {
          id: 'prod-2',
          category_id: 'cat-2',
          name: 'AURA Cyberpunk Zip-Up Hoodie',
          price: 1890.00,
          ...
          image_url: 'https://down-th.img.susercontent.com/file/sg-11134201-7reqb-m1tite0vlm4df1',
          additional_images: [],
          sizes: ['M', 'L', 'XL'],
        ...
        },
        {
          ...
          image_url: 'https://down-th.img.susercontent.com/file/th-11134207-81ztc-mntwxn4mrz0oa3',
          additional_images: [],
        ...
        },
        {
          ...
          image_url: 'https://down-th.img.susercontent.com/file/sg-11134201-7qvg9-lj57axed4n77a5',
          additional_images: [],
          sizes: ['M', 'L', 'XL'],
        ...
        },
        {
          id: 'prod-6',
          category_id: 'cat-1',
          name: 'Minimalist Vintage Graphic Tee',
          price: 890.00,
          original_price: 1290.00,
          description: 'เสื้อยืดลายกราฟิกแนวสตรีท สกรีนลายความละเอียดสูง ซักไม่ลอก ทรง Boxy Fit ทันสมัย',
          image_url: 'https://down-th.img.susercontent.com/file/sg-11134201-22120-ficxp6jt8qkv0d',
          additional_images: [],
          sizes: ['S', 'M', 'L', 'XL'],
        ...
        },
        {
          id: 'prod-7',
          category_id: 'cat-2',
          name: 'AURA Urban Techwear Jacket',
          price: 2490.00,
          original_price: 3190.00,
          description: 'แจ็คเก็ตแนวเทควูด ทรงลักชูรี กันน้ำกันลม พร้อมซิปและกระเป๋ากล่องอเนกประสงค์',
          image_url: 'https://img.lazcdn.com/g/p/1135b38b9d030a5fccfa5c25d0d41160.png_720x720q80.png',
          additional_images: [],
          sizes: ['S', 'M', 'L', 'XL'],
        ...
        },
        {
          id: 'prod-8',
          category_id: 'cat-2',
          name: 'Essential Oversized Pullover Hoodie',
          price: 1690.00,
          original_price: 2190.00,
          description: 'เสื้อฮู้ดดี้แขนยาวทรง Oversized สวมใส่สบาย สไตล์มินิมอลเรียบหรู เข้าได้กับทุกสไตล์การแต่งตัว',
          image_url: 'https://down-th.img.susercontent.com/file/sg-11134201-7req9-m8nlnkxg2kyx6b',
          additional_images: [],
          sizes: ['M', 'L', 'XL', 'XXL'],
          colors: ['Charcoal Gray', 'Off White'],
          stock: 40,
          is_featured: true
        },
        {
          id: 'prod-9',
          category_id: 'cat-3',
          name: 'AURA Relaxed Streetwear Sweatpants',
          price: 1290.00,
          original_price: 1690.00,
          description: 'กางเกงวอร์มขายาวสตรีทแฟชั่น ทรง Relaxed Fit ขอบเอวยางยืดพร้อมสายปรับได้',
          image_url: 'https://down-th.img.susercontent.com/file/sg-11134201-7rdwe-lzhfxqd4k2lk35',
          additional_images: [],
          sizes: ['S', 'M', 'L', 'XL'],
        ...
        },
        {
          id: 'prod-10',
          category_id: 'cat-1',
          name: 'AURA Limited Edition Graphic Hoodie',
          price: 1990.00,
          original_price: 2590.00,
          description: 'เสื้อฮู้ดสกรีนลายกราฟิกลิมิเต็ดเฉพาะแบรนด์ AURA คอลเลกชันประจำปี 2026',
          image_url: 'https://down-th.img.susercontent.com/file/th-11134207-7r98o-lt7n6t70pkry50',
          additional_images: [],
          sizes: ['M', 'L', 'XL'],
