                            ...
                            <td style={styles.td}>
                              ...
                              {ord.status === 'preparing' && (
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                                  <span className="badge badge-success" style={{ background: 'rgba(16, 185, 129, 0.15)', color: '#34d399' }}>กำลังเตรียมพัสดุ</span>
                                  {ord.payment_details?.is_auto_verified && (
                                    <span style={{ fontSize: '10px', color: 'var(--secondary)', fontWeight: '700' }}>⚡ อนุมัติออโต้ (SlipOK)</span>
                                  )}
                                </div>
                              )}
